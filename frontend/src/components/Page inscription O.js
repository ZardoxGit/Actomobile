...
const PageInscriptionO = (props) => {
  return (
    ...
    <div>
      ...
      <Button style={{marginLeft: '150px', marginTop:'30px', backgroundColor: '#803bca', color: 'white', fontFamily: 'Roboto', fontSize:'13px', marginBottom:'40px'}}>S'INSCRIRE</Button>
    </div>
    </Col>
  );
}

export default PageInscriptionO;